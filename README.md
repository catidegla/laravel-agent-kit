...
Requires PHP 8.2 and **Laravel 12 or 13**. Laravel 13 sets its own floor at PHP 8.3, so on 8.2 Composer
resolves you to 12, which is the intended outcome rather than a failure.
